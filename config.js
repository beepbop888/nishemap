// НищеMap config
// Бесплатный ключ: https://developer.tech.yandex.ru → "JavaScript API и HTTP Геокодер"
// Вставь ключ между кавычками и обнови страницу — карта проснётся.
window.NISHEMAP_CONFIG = {
