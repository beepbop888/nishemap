...
DESCRIPTION = (
    "\U0001F35C НищеMap — карта дешёвой еды в Москве и Питере.\n\n"
    "\U0001F32F Шаурма, пельменные, столовые, бизнес-ланчи — с ценами, которые проверили живые люди, а не реклама.\n"
    "\U0001F4CD Смотри, где поесть рядом и за сколько — ещё до того, как выйдешь из дома.\n"
    "➕ Нашёл дешевле — добавь точку и забери монеты.\n"
    "\U0001F3C5 На монеты открываются аватары и медали.\n\n"
    "\U0001F447 Жми «Запустить» — карта откроется прямо здесь."
)

# 120 символов максимум: превью в профиле и в пересылке ссылки на бота.
SHORT = (
    "\U0001F35C Карта дешёвой еды Москвы и Питера: шаурма, столовые, ланчи. "
    "Цены от людей \U0001F4CD"
)
